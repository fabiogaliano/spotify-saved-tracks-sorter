...
export const PlaylistUIProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
	...
	const updateSelectedPlaylist = useCallback(
		(playlistId: string | null, tab?: PlaylistDetailViewTabs) => {
			if (playlistId) {
	...
	return <PlaylistUIContext.Provider value={value}>{children}</PlaylistUIContext.Provider>
}
