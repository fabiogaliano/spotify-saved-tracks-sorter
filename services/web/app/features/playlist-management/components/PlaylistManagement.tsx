	...
	return (
		<div className="flex h-full flex-col">
			...
			<div className="grid min-h-0 flex-1 grid-cols-1 gap-6 lg:grid-cols-12">
				...
				<div className="flex min-h-0 flex-col gap-6 overflow-hidden lg:col-span-9">
					{currentPlaylist && (
						<>
							<PlaylistDetailsView
							...
							<TracksList
								...
								rescanAction={
									<div className="flex items-center gap-2">
										<Button variant="outline" size="sm" onClick={handleRescanPlaylist}>
										...
										>
											<Sparkles
												className={`mr-1.5 h-3.5 w-3.5 ${isAnalyzingTracks ? 'animate-pulse' : ''}`}
											/>
											{isAnalyzingTracks ?
												'Analyzing...'
											:	`Analyze Tracks (${rawPlaylistTracks?.length || 0})`}
										</Button>
									</div>
								}
							/>
