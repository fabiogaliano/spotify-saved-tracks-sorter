...
import { createSongAnalysisService } from '~/lib/utils/analysisUtils';
import { createClient } from '@supabase/supabase-js';
import { Database } from '~/types/database.types';
import { createErrorInfo, logError, ErrorCategory } from '../utils/errorHandling';

// Define the payload structure for this task
interface AnalyzeTrackPayload {
  jobId: number;
  trackId: number;
  userId: number;
}
